...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['published']['0'] = "Pubblica l'album";
...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['edit']['1'] = "Modifica l'album con l'ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['delete']['0'] = "Cancella album";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['delete']['1'] = "Cancella l'album con l'ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['upload_images']['0'] = "Carica immagini";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['upload_images']['1'] = "Carica immagini all'album con ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['import_images']['0'] = "Copia le immagini da una directory sul server";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['import_images']['1'] = "Copia le immagini da una directory sul server nell'album con ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['cut']['0'] = "Muovi l'album";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['cut']['1'] = "Muovi l'album con ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['pasteafter']['0'] = "Copia dopo";
