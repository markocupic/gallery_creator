...
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['customThumb']['0'] = "Ein alternatives Vorschaubild ausw&auml;hlen.";
...
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['delete']['0'] = "Bild l&ouml;schen";
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['delete']['1'] = "Bild mit ID %s l&ouml;schen";
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['cut']['0'] = "Reihenfolge &auml;ndern";
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['cut']['1'] = "Bild mit ID %s verschieben";
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['paste']['0'] = "Unterhalb einf&uuml;gen";
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['paste']['1'] = "Unterhalb Bild mit ID %s einf&uuml;gen";
