...
$GLOBALS['TL_LANG']['tl_module']['gc_template']['1'] = "Hier k&ouml;nnen Sie das Galerietemplate ausw&auml;hlen.";
$GLOBALS['TL_LANG']['tl_module']['gc_activateThumbSlider']['0'] = "Ajax-Thumb-Slider aktivieren";
$GLOBALS['TL_LANG']['tl_module']['gc_activateThumbSlider']['1'] = "Ajax-Thumb-Slider bei mouseover in der Alben&uuml;bersicht aktivieren?";
$GLOBALS['TL_LANG']['tl_module']['gc_AlbumsPerPage']['0'] = "Anzahl Alben pro Seite in der Alben&uuml;bersicht";
$GLOBALS['TL_LANG']['tl_module']['gc_AlbumsPerPage']['1'] = "Die Anzahl an Alben pro Seite in der Alben&uuml;bersicht. Geben Sie 0 ein, um den automatischen Seitenumbruch zu deaktivieren.";
