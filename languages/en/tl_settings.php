...
$GLOBALS['TL_LANG']['tl_settings']['gc_read_exif'] = array('Read-out exif data','Read-out the exif data (Requires memory!!!)');
$GLOBALS['TL_LANG']['tl_settings']['gc_error404_thumb'] = array('Error 404 Thumbnail','Please select an alternate thumbnail.');
