...
class GcHelpers extends \System
{
    ...
    public static function getAlbumInformationArray($intAlbumId, $objThis)
    {
        ...
        if ($objThis->gc_hierarchicalOutput) {
...
*/
    ...
    public static function getAllSubalbums($parentId)
    {
        ...
        $arrSubAlbums = array();
        $objAlb = \Database::getInstance()->prepare('SELECT id FROM tl_gallery_creator_albums WHERE pid=? ORDER BY sorting')->execute($parentId);
        while ($objAlb->next()) {
