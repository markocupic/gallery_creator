...
class ContentGalleryCreator extends \ContentElement
{
    ...
    public function getUrlParams()
    {
        ...
        if (\Input::get('items'))
        {
            ...
            //Authentifizierung bei vor Zugriff gesch�tzten Alben, dh. der Benutzer bekommt, wenn nicht berechtigt, nur das Albumvorschaubild zu sehen.
    ...
    protected function getAlbumTemplateVars($intAlbumId)
    {
        ...
        $this->Template->albumComment = $objPage->outputFormat == 'xhtml' ? \StringUtil::toXhtml(nl2br_xhtml($objAlbum->comment)) : \StringUtil::toHtml5(nl2br_html5($objAlbum->comment));
